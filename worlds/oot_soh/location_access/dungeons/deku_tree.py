...
def create_deku_tree_locations(world: "SohWorld") -> None:
    ...
    # Deku Tree Lobby locations
    lobby_locations = [
        Locations.DEKU_TREE_MAP_CHEST.value,
        Locations.DEKU_TREE_LOBBY_LOWER_HEART.value,
        Locations.DEKU_TREE_LOBBY_UPPER_HEART.value,
        Locations.DEKU_TREE_LOBBY_GRASS1.value,
        Locations.DEKU_TREE_LOBBY_GRASS2.value,
        Locations.DEKU_TREE_LOBBY_GRASS3.value,
        Locations.DEKU_TREE_LOBBY_GRASS4.value,
        Locations.DEKU_TREE_LOBBY_GRASS5.value,
    ]
    
    lobby_region = world.multiworld.get_region(Regions.DEKU_TREE_LOBBY.value, world.player)
    for location_name in lobby_locations:
        location = world.create_location(location_name)
        lobby_region.locations.append(location)

    # Deku Tree Slingshot Room locations
    slingshot_locations = [
        Locations.DEKU_TREE_SLINGSHOT_CHEST.value,
        Locations.DEKU_TREE_SLINGSHOT_ROOM_SIDE_CHEST.value,
        Locations.DEKU_TREE_SLINGSHOT_GRASS_1.value,
        Locations.DEKU_TREE_SLINGSHOT_GRASS_2.value,
        Locations.DEKU_TREE_SLINGSHOT_GRASS_3.value,
        Locations.DEKU_TREE_SLINGSHOT_GRASS_4.value,
    ]
    
    slingshot_region = world.multiworld.get_region(Regions.DEKU_TREE_SLINGSHOT_ROOM.value, world.player)
    for location_name in slingshot_locations:
        location = world.create_location(location_name)
        slingshot_region.locations.append(location)

    # Deku Tree Compass Room locations
    compass_locations = [
        Locations.DEKU_TREE_COMPASS_CHEST.value,
        Locations.DEKU_TREE_COMPASS_ROOM_SIDE_CHEST.value,
        Locations.DEKU_TREE_GSCOMPASS_ROOM.value,
        Locations.DEKU_TREE_COMPASS_GRASS_1.value,
        Locations.DEKU_TREE_COMPASS_GRASS_2.value,
    ]
    
    compass_region = world.multiworld.get_region(Regions.DEKU_TREE_COMPASS_ROOM.value, world.player)
    for location_name in compass_locations:
        location = world.create_location(location_name)
        compass_region.locations.append(location)

    # Deku Tree Basement Lower locations
    basement_lower_locations = [
        Locations.DEKU_TREE_BASEMENT_CHEST.value,
        Locations.DEKU_TREE_GSBASEMENT_GATE.value,
        Locations.DEKU_TREE_GSBASEMENT_VINES.value,
        Locations.DEKU_TREE_BASEMENT_GRASS_1.value,
        Locations.DEKU_TREE_BASEMENT_GRASS_2.value,
    ]
    
    basement_lower_region = world.multiworld.get_region(Regions.DEKU_TREE_BASEMENT_LOWER.value, world.player)
    for location_name in basement_lower_locations:
        location = world.create_location(location_name)
        basement_lower_region.locations.append(location)

    # Deku Tree Basement Scrub Room locations
    basement_scrub_room_locations = [
        Locations.DEKU_TREE_BASEMENT_SCRUB_ROOM_GRASS_1.value,
        Locations.DEKU_TREE_BASEMENT_SCRUB_ROOM_GRASS_2.value,
        Locations.DEKU_TREE_BASEMENT_SCRUB_ROOM_GRASS_3.value,
        Locations.DEKU_TREE_BASEMENT_SCRUB_ROOM_GRASS_4.value,
    ]
    
    basement_scrub_room_region = world.multiworld.get_region(Regions.DEKU_TREE_BASEMENT_SCRUB_ROOM.value, world.player)
    for location_name in basement_scrub_room_locations:
        location = world.create_location(location_name)
        basement_scrub_room_region.locations.append(location)

    # Deku Tree Basement Water Room Back locations
    basement_water_room_back_locations = [
        Locations.DEKU_TREE_BASEMENT_SPIKE_ROLLER_GRASS_1.value,
        Locations.DEKU_TREE_BASEMENT_SPIKE_ROLLER_GRASS_2.value,
    ]
    
    basement_water_room_back_region = world.multiworld.get_region(Regions.DEKU_TREE_BASEMENT_WATER_ROOM_BACK.value, world.player)
    for location_name in basement_water_room_back_locations:
        location = world.create_location(location_name)
        basement_water_room_back_region.locations.append(location)

    # Deku Tree Basement Torch Room locations
    basement_torch_room_locations = [
        Locations.DEKU_TREE_BASEMENT_TORCHES_GRASS_1.value,
        Locations.DEKU_TREE_BASEMENT_TORCHES_GRASS_2.value,
    ]
    
    basement_torch_room_region = world.multiworld.get_region(Regions.DEKU_TREE_BASEMENT_TORCH_ROOM.value, world.player)
    for location_name in basement_torch_room_locations:
        location = world.create_location(location_name)
        basement_torch_room_region.locations.append(location)

    # Deku Tree Basement Back Lobby locations
    basement_back_lobby_locations = [
        Locations.DEKU_TREE_BASEMENT_LARVAE_GRASS_1.value,
        Locations.DEKU_TREE_BASEMENT_LARVAE_GRASS_2.value,
    ]
    
    basement_back_lobby_region = world.multiworld.get_region(Regions.DEKU_TREE_BASEMENT_BACK_LOBBY.value, world.player)
    for location_name in basement_back_lobby_locations:
        location = world.create_location(location_name)
        basement_back_lobby_region.locations.append(location)

    # Deku Tree Outside Boss Room locations
    outside_boss_room_locations = [
        Locations.DEKU_TREE_BEFORE_BOSS_LEFT_HEART.value,
        Locations.DEKU_TREE_BEFORE_BOSS_MIDDLE_HEART.value,
        Locations.DEKU_TREE_BEFORE_BOSS_RIGHT_HEART.value,
        Locations.DEKU_TREE_BEFORE_BOSS_GRASS_1.value,
        Locations.DEKU_TREE_BEFORE_BOSS_GRASS_2.value,
        Locations.DEKU_TREE_BEFORE_BOSS_GRASS_3.value,
    ]
    
    outside_boss_room_region = world.multiworld.get_region(Regions.DEKU_TREE_OUTSIDE_BOSS_ROOM.value, world.player)
    for location_name in outside_boss_room_locations:
        location = world.create_location(location_name)
        outside_boss_room_region.locations.append(location)

    # Deku Tree Basement Back Room locations
    basement_back_room_locations = [
        Locations.DEKU_TREE_GSBASEMENT_BACK_ROOM.value,
    ]
    
    basement_back_room_region = world.multiworld.get_region(Regions.DEKU_TREE_BASEMENT_BACK_ROOM.value, world.player)
    for location_name in basement_back_room_locations:
        location = world.create_location(location_name)
        basement_back_room_region.locations.append(location)

    # Deku Tree Boss Room locations
    boss_locations = [
        Locations.DEKU_TREE_QUEEN_GOHMA_HEART_CONTAINER.value,
    ]
    
    boss_region = world.multiworld.get_region(Regions.DEKU_TREE_BOSS_ROOM.value, world.player)
